	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
				...
				<div class="row">
				<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
					<p> Description of the post. This post could be arbitarily long so I am writing something random here to test it outside lol. So I am increasing my banter here to show that I really need some more nonsense to work with</p> 
				</div>
			</div>
			</div>
		</div>
